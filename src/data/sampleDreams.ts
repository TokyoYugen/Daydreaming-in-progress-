...
export function getLocalizedDream(dream: DreamEntry, language: Language): DreamEntry {
  ...
  if (dream.id === 'sample-dream-1') {
    ...
    return {
      ...base,
      ...dream,
      title: (dream.title && dream.title !== SAMPLE_DREAMS_EN[0].title && dream.title !== SAMPLE_DREAMS_IT[0].title) ? dream.title : base.title,
      transcription: (dream.transcription && dream.transcription !== SAMPLE_DREAMS_EN[0].transcription && dream.transcription !== SAMPLE_DREAMS_IT[0].transcription) ? dream.transcription : base.transcription,
      interpretation: dream.interpretation && dream.interpretation !== SAMPLE_DREAMS_EN[0].interpretation && dream.interpretation !== SAMPLE_DREAMS_IT[0].interpretation ? dream.interpretation : base.interpretation,
  ...
  if (dream.id === 'sample-dream-2') {
    ...
    return {
      ...base,
      ...dream,
      title: (dream.title && dream.title !== SAMPLE_DREAMS_EN[1].title && dream.title !== SAMPLE_DREAMS_IT[1].title) ? dream.title : base.title,
      transcription: (dream.transcription && dream.transcription !== SAMPLE_DREAMS_EN[1].transcription && dream.transcription !== SAMPLE_DREAMS_IT[1].transcription) ? dream.transcription : base.transcription,
      interpretation: dream.interpretation && dream.interpretation !== SAMPLE_DREAMS_EN[1].interpretation && dream.interpretation !== SAMPLE_DREAMS_IT[1].interpretation ? dream.interpretation : base.interpretation,
      isFavorite: dream.isFavorite ?? base.isFavorite,
      imageUrl: dream.imageUrl || base.imageUrl,
      chatHistory: hasUserChat ? dream.chatHistory : base.chatHistory,
      isSample: true,
